---
title: 如何在 Django 中进行接口开发
date: 2024-12-25T11:07:22+08:00
...
# 在 app 应用 django_web 下新建 urls.py 添加具体接口
...
# 在创建接口视图函数 view_api.py 文件，使用 FBV 形式实现具体接口
