...
1.下载软件：[ Molunerfinn/PicGo · GitHub ](https://github.com/Molunerfinn/PicGo/releases)

2.安装插件：**gitee-uploader**（**注意插件的安装需要使用 node.js**）

![](_images/drawingbed/img/Pasted%20image%2020251208153451.png)

3.选择**图床设置**，选择 **gitee**，填写以下的配置
...
![](_images/drawingbed/img/Pasted%20image%2020251208153855.png)

4.在配置完成后，即可在**上传区**选择 gitee 上传图片

![](_images/drawingbed/img/Pasted%20image%2020251208153941.png)
